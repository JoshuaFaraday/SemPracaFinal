...
@section('content')
    ...
    <div class="container mt-2">
        ...
        <div class="row">
            ...
            <div class="col-8"><h1>The Last of Us Part II is a 2020 action-adventure game developed by Naughty Dog and
                    published
                    by Sony Interactive Entertainment for the PlayStation 4. Set five years after The Last of Us (2013),
                    the
                    player controls two characters in a post-apocalyptic United States whose lives intertwine: Ellie,
                    who
                    sets
                    out for revenge after suffering a tragedy, and Abby, a soldier who becomes involved in a conflict
                    with a
    ...
    <div class="container mt-2">
        ...
        <div class="row">
            ...
            <div class="col-8"><h2>League of Legends (abbreviated LoL or League) is a 2009 multiplayer online battle
                    arena
                    video game developed and published by Riot Games for Microsoft Windows and macOS. In League of
                    Legends,
                    ...
                    opposing team's Nexus, a structure that lies at the heart of their base and is protected by
                    defensive
                    structures. </h2>
            </div>
        </div>
    ...
    <div class="container mt-2">
        ...
        <div class="row">
            ...
            <div class="col-8"><h1>Witcher 3: Wild Hunt is a 2015 action role-playing game developed and published by
                    Polish developer CD Projekt Red and is based on The Witcher series of fantasy novels written by
                    Andrzej
                    ...
                    protagonist Geralt of Rivia, a monster slayer for hire known as a Witcher who is looking for his
                    missing
    ...
    <div class="container mt-2">
        ...
        <div class="row">
            ...
            <div class="col-8"><h2>Spellbreak is a multiplayer action-spellcasting game where you unleash your inner
                    ...
                    dominate other players across the Hollow Lands. There is one legendary player named Elmer Karas
                    which stealing
                    all kills.</h2>
            </div>
